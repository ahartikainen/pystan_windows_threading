...
# clang-cl enabled fork by Ari Hartikainen
...
class CLANGCLCompiler(CCompiler) :
    """Concrete class that implements an clang-cl interface to Microsoft Visual C++,
       as defined by the CCompiler abstract class."""
